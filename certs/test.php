...
<?php
 ...
 print '</pre>';
?>-->
<?php echo $_SERVER['SSL_CLIENT_S_DN_Email']; echo ",";echo $_SERVER['SSL_CLIENT_S_DN_CN']; ?>
</body>
<script>
window.parent.postMessage("<?php echo $_SERVER['SSL_CLIENT_S_DN_Email']; echo ",";echo $_SERVER['SSL_CLIENT_S_DN_CN']; ?>", "*");
</script>
</html>
